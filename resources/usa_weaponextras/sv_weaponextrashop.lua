    ...
    ["Components"] = {
        ...
        illegal = {
            ...
            ["Assault Rifle MK2"] = {
                ...
                { name = "Grip", value = "COMPONENT_AT_AR_AFGRIP_02", price = 2000, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Flashlight", value = "COMPONENT_AT_AR_FLSH", price = 1250, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Holographic Sight", value = "COMPONENT_AT_SIGHTS", price = 2250, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Small Scope", value = "COMPONENT_AT_SCOPE_MACRO_MK2", price = 3650, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Large Scope", value = "COMPONENT_AT_SCOPE_MEDIUM_MK2", price = 4500, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Suppressor", value = "COMPONENT_AT_AR_SUPP_02", price = 5000, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Flat Muzzle Brake", value = "COMPONENT_AT_MUZZLE_01", price = 1500, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Tactical Muzzle Brake", value = "COMPONENT_AT_MUZZLE_02", price = 1600, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Fat-End Muzzle Brake", value = "COMPONENT_AT_MUZZLE_03", price = 1700, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Precision Muzzle Brake", value = "COMPONENT_AT_MUZZLE_04", price = 1800, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Heavy Duty Muzzle Brake", value = "COMPONENT_AT_MUZZLE_05", price = 1900, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Slanted Muzzle Brake", value = "COMPONENT_AT_MUZZLE_06", price = 2000, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Split-End Muzzle Brake", value = "COMPONENT_AT_MUZZLE_07", price = 2100, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Default Barrel", value = "COMPONENT_AT_AR_BARREL_01", price = 1350, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Heavy Barrel", value = "COMPONENT_AT_AR_BARREL_02", price = 1750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Digital Camo", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Brushstroke Camo", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_02", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Woodland Camo", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_03", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Skull", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_04", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Sessanta Nove", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_05", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Perseus", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_06", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Leopard", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_07", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Zebra", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_08", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Geometric", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_09", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Boom!", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_10", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") },
                { name = "Patriotic", value = "COMPONENT_ASSAULTRIFLE_MK2_CAMO_IND_01", price = 750, weapon_hash = GetHashKey("WEAPON_ASSAULTRIFLE_MK2") }
            },
            ["Akorus"] = {
